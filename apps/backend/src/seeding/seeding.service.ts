...
export class SeedingService {
  ...
  async seed() {
    ...
    const admin = this.userRepository.create({
      email: 'digital.lockkiyajaye@gmail.com',
    ...
    for (let i = 0; i < approvedOwners.length; i++) {
      ...
      for (let j = 1; j <= 2 + (i % 2); j++) {
        ...
        const turfData: Partial<Turf> = {
          ...
          rules: 'No metal studs allowed. Please arrive 10 minutes before your slot.',
          ...
          longitude: -74.006 + j * 0.01,
          googleMapUrl: `https://maps.google.com/?q=${40.7128 + i * 0.01},${-74.006 + j * 0.01}`,
          mapUrl: `https://maps.google.com/?q=${40.7128 + i * 0.01},${-74.006 + j * 0.01}`,
